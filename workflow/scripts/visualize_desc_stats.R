...
# 
# Description:
#   This program plots barplots, boxplots & violin plots relating to 
...
#   3. Perform data wrangling & plot descriptive statistics in barplots
...
svglite(paste(paste(outfile_basename, "SingletonRatio", sep = "__"), "svg", sep = "."), width = 10, height = 8)
plot_singleton_ratio
dev.off()
